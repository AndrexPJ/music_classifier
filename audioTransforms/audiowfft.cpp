...
bool AudioWFFT::perform(AudioRecord &in_record, AudioSpectrum<complex> &out_spectrum, int window_size, int hop_size, int channels_count){
    ...
    out_spectrum.setDataSize(channels_true_count,in_record.channelDataSize/2);
